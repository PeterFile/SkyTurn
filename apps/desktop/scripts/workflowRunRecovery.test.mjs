...
async function loadMainWorkflowStoreHarness(options = {}) {
  ...
  const source = [
    ...
    "function assertWorkflowAdvanceAdmissionOpen(expectedEpoch = workflowAdvanceAdmissionEpoch) { if (!workflowAdvanceAdmissionOpen || workflowAdvanceAdmissionEpoch !== expectedEpoch) throw new Error(workflowAdvanceShutdownError); return expectedEpoch; }",
