...
export function buildHermesWorkflowPrompt(input: HermesWorkflowPromptInput): string {
  return [
    ...
    "Hermes owns lane granularity; SkyTurn validates and schedules the DAG lanes and edges.",
    "Do not rely on SkyTurn policy-pack fallback for user-request decomposition.",
